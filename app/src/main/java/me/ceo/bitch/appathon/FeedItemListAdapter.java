...
public class FeedItemListAdapter extends ArrayAdapter {
    ...
    public FeedItemListAdapter(Context context, List items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        FeedItemListItem fragmentItemListItem = (FeedItemListItem)getItem(position);
        View viewToUse = null;
        ...
        if (convertView == null) {
            if(useList){
                ...
                viewToUse = mInflater.inflate(R.layout.fragment_feeditem_griditem_grid, null);
            }
