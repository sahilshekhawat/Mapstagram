...
public class MainActivity extends Activity implements ActionBar.TabListener {
    ...
    public boolean startUploadPicture(){
        Intent intent = new Intent(this, UploadPictureActivity.class);
        startActivity(intent);
        return true;
    }

    public boolean startWriteReview(){
        Intent intent = new Intent(this, WriteReviewActivity.class);
        startActivity(intent);
        return true;
    }

    public boolean startCheckIn(){
        Intent intent = new Intent(this, CheckInActivity.class);
        startActivity(intent);
        return true;
    }

    public boolean startPlaceActivity(){
        Intent intent = new Intent(this, PlaceActivity.class);
        startActivity(intent);
        return true;
    }

    public boolean startProfileActivity(){
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem locationitem = menu.findItem(R.id.location_place);
        ...
        MenuItem uploaditem = menu.findItem(R.id.upload_pic);
        uploaditem.setOnMenuItemClickListener
                (
                        new MenuItem.OnMenuItemClickListener ()
                        {
                            public boolean onMenuItemClick(MenuItem item)
                            { return (startUploadPicture()); }
                        }
                );
        MenuItem reviewitem = menu.findItem(R.id.write_review);
        reviewitem.setOnMenuItemClickListener
                (
                        new MenuItem.OnMenuItemClickListener ()
                        {
                            public boolean onMenuItemClick(MenuItem item)
                            { return (startWriteReview()); }
                        }
                );
